...
class Body3_interaction_MACE(torch.nn.Module):
    ...
    def forward(self, irreps_x, atomic_numbers, **kwargs):
        ...
        import torch
        from torch import logical_not, nn
        from molfm.models.psm.equivariant.e2former import Body3_interaction_MACE
...
class TransBlock(torch.nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        from molfm.models.psm.equivariant.e2former import TransBlock
...
class E2former(torch.nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        example:
        import torch
        from molfm.models.psm.equivariant.e2former import E2former
        func = E2former(
