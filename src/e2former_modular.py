...
This file contains the main E2former and E2formerCluster classes along with their
required helper functions and specialized attention modules.
...
from .attention import E2TensorProductArbitraryOrder
from .embeddings import EdgeDegreeEmbeddingNetwork_higherorder, EdgeDegreeEmbeddingNetwork_eqv2
from .blocks import (
    TransBlock,
    ...
    def forward(
        ...
        **kwargs,
        ...
        Example usage:
            ...
            batched_data = {
                "pos": node_positions,  # [B, L, 3]
                "atomic_numbers": atomic_numbers,  # [B, L]
                "atom_masks": atom_masks,  # [B, L]
                "pbc": pbc_flags,  # [B, 3]
                # ... other required fields
            }
            
            node_attr, node_vec = model(batched_data, token_embedding)
        """
